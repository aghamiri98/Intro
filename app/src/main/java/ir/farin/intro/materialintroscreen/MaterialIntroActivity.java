package ir.farin.intro.materialintroscreen;
...
import ir.farin.intro.materialintroscreen.adapter.SlidesAdapter;
import ir.farin.intro.materialintroscreen.animations.ViewTranslationWrapper;
import ir.farin.intro.materialintroscreen.animations.wrappers.BackButtonTranslationWrapper;
import ir.farin.intro.materialintroscreen.animations.wrappers.NextButtonTranslationWrapper;
import ir.farin.intro.materialintroscreen.animations.wrappers.PageIndicatorTranslationWrapper;
import ir.farin.intro.materialintroscreen.animations.wrappers.SkipButtonTranslationWrapper;
import ir.farin.intro.materialintroscreen.animations.wrappers.ViewPagerTranslationWrapper;
import ir.farin.intro.materialintroscreen.listeners.IFinishListener;
import ir.farin.intro.materialintroscreen.listeners.IPageScrolledListener;
import ir.farin.intro.materialintroscreen.listeners.IPageSelectedListener;
import ir.farin.intro.materialintroscreen.listeners.MessageButtonBehaviourOnPageSelected;
import ir.farin.intro.materialintroscreen.listeners.ViewBehavioursOnPageChangeListener;
import ir.farin.intro.materialintroscreen.listeners.clickListeners.PermissionNotGrantedClickListener;
import ir.farin.intro.materialintroscreen.listeners.scrollListeners.ParallaxScrollListener;
import ir.farin.intro.materialintroscreen.widgets.InkPageIndicator;
import ir.farin.intro.materialintroscreen.widgets.OverScrollViewPager;
import ir.farin.intro.materialintroscreen.widgets.SwipeableViewPager;
